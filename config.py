...
API_ID = int(getenv("29451118"))
API_HASH = getenv("5db13c8684e81957530cae0791b7cbb8")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("BOT_TOKEN")
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","ROYAL_QUEEN91")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","ROYAL_MUSICC_BOT")
# --------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002722867880))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 7852717620))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MARS_MACHAL_SUPPORT")
